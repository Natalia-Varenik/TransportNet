...
class Model:
    ...
    def find_equilibrium(self, solver_name = 'ustm', composite = True, solver_kwargs = {}, base_flows = None, t_start=None):
        if solver_name == 'fwm':
        ...
        if t_start is None:
            ...
            print('Free flow times are used as t_start...')
        else:
            print('Given point is used as t_start...')
